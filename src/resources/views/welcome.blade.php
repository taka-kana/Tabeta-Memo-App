...
<section class="welcome">
    ...
    <div class="welcome__recommendation">
        ...
        <h3 class="welcome__recommendation-item is-sp">育児中のパパ・ママをはじめとする全ての人にお使いいただけます。育児・介護・ペットとの生活において大切な人の好きなもの
            ・嫌いなものが記録できます。離乳食や、アレルギーの記録、ご飯・おやつの摂取量の記録に便利です。
        </h3>
        ...
        <div class="welcome__recommendation-image-wrapper2">
            ...
            また、育児・介護・ペットとの生活以外にもお菓子作りの記録やパートナーの好みを記録するツールとしてもご利用いただけます。みんなの記録に投稿し、料理のモチベーションをアップさせることもできます。
        </h3>
    </div>
