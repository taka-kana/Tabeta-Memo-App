...
<section class="edit">
    <div class="container">
        ...
        <div class="edit-form-wrapper">
            ...
            <!--form-->
            <form action="" method="POST" name="edit-form" id="js-form">
                ...
                <div class="form_area wow fadeInDown">
                    <div class="form_item-title">メモ<span class="alert">&nbsp;*</span></div>
                        <div class="form_area-wrapper">
                            <textarea class="edit-form_summary" name="" id="" cols="30" rows="10"></textarea>
                ...
                <div class="form_area wow fadeInDown">
                    ...
                    <div class="edit-form_reaction-area-wrapper">
                        <div class="edit-radio_wrapper">
                            <label>
                                <input type="radio" name="reaction" value="今回だけ" class="form_reaction-select"><span><i class="far fa-grimace reaction-icon" ></i>あんまり…。</span>
                            </label>
                            <label>
